...
public class PathAndJsonPath {
      ...
      @Test
        public void extractingPath(){
            ...
            int postCode=  // BURADA CAST HATASI VERİR STRİNGİ İNT OLARAK YAZDIK
                    given()
        ...
        public void extractingJosnPath(){
            ...
            int postCode=
                    given()
                            ...
                            .then()
                            .log().body()
                            .extract().jsonPath().getInt("'post code'")  //  GETINT YAPTIĞIMIZ ZAMAN HATALI DA YAZSAK BİLGİYİ ALABİLİRİZ,OTOMATİK TİP DÖNÜŞÜMÜ YAPAR
        ...
        public void getUsers(){
            ...
            Response response=  // RESPONSE TÜM BİLGİYİ ALMAK İÇİN KULLANIYORUZ-- BÜTÜN BODY SONUCUNU ALDIK
                    given()
            ...
            User[]usersPath=response.as(User[].class); // AS NESNE DÖNÜŞÜMÜNDE (POJO) DİZİ DESTEKLİ  -- TÜM USERS LARI ALDIK -- TÜM DATAYI ALDIK
            List<User> usersJsonPath=response.jsonPath().getList("",User.class); // JSON PATH İSE LİST OLARAK VEREBİLİYOR
    ...
    public void getZipCode(){
        ...
        List<Place> places= response.jsonPath().getList("places", Place.class); // NOKTA ATIŞI İSTEDİĞİMİZ NESNEYİ ALDIK
